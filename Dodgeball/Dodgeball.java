...
public class Dodgeball {
    public static void main(String[] args) {
        ...
        displayField(field);
        System.out.print("Player 1 command (move, quit, throw): ");
        ...
        while (!command.equalsIgnoreCase("quit")) {
            if (command.equalsIgnoreCase("move")) {
                ...
                System.out.println("Invalid input! use move, throw or quit command");
            }
    ...
    public static void playerMove(String[] field, Scanner input) {
        ...
        System.out.print("How far? (negative to go left, positive to go right) ");
